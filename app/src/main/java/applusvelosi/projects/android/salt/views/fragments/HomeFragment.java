...
public class HomeFragment extends ActionbarFragment implements RootFragment, OnPageChangeListener, StaffLeaveSyncListener{
...
//		TODO
	...
	public View createView(LayoutInflater li, ViewGroup vg, Bundle b) {
		View view = li.inflate(R.layout.fragment_home, null);
