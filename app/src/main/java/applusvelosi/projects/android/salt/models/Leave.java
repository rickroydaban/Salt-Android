...
//			return LEAVESTATUSCANCELKEY;
	...
	public Leave(Staff staff, float staffRemVL, float staffRemSL, int typeID, int statusID, String dateFrom, String dateTo, float days,  float workingDays, String notes, String dateSubmitted){
		...
		mapLeave.put("LeaveApprover1ID", staff.getLeaveApprover1ID());
		mapLeave.put("LeaveApprover1Name", staff.getLeaveApprover1Name());
		mapLeave.put("LeaveApprover1Email", staff.getLeaveApprover1Email());
		mapLeave.put("LeaveApprover2ID", staff.getLeaveApprover2ID());
		mapLeave.put("LeaveApprover2Name", staff.getLeaveApprover2Name());
		mapLeave.put("LeaveApprover2Email", staff.getLeaveApprover2Email());
		mapLeave.put("LeaveApprover3ID", staff.getLeaveApprover3ID());
		mapLeave.put("LeaveApprover3Name", staff.getLeaveApprover3Name());
		mapLeave.put("LeaveApprover3Email", staff.getLeaveApprover3Email());
