...
public class ClaimInputOverviewLiquidationFragment extends HomeActionbarFragment {
    ...
    protected RelativeLayout setupActionbar() {
        ...
        actionbarTitle.setText("New Liquidation");
    ...
    protected View createView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_claimheaderinputoverview_liquidation, null);
        ...
        tvType.setText(ClaimHeader.TYPEDESC_LIQUIDATION);
                    ...
                    public void run() {
                        ...
                        if(result instanceof String){
                            ...
                            for (int i=0; i<costCenters.size(); i++) {
                                ...
                                node.setOnClickListener(ClaimInputOverviewLiquidationFragment.this);
                                node.setTag(i);
    ...
    public void onClick(View v) {
        if(v == actionbarButtonBack || v == actionbarTitle){
            ...
            if(selectedCostCenterPos > 0){
                ...
                final LiquidationOfBA newClaimHeader;
                ...
                if(getArguments() == null){
                    try{
                        ...
                        newClaimHeader = new LiquidationOfBA(app, selectedCostCenter.getCostCenterID(), selectedCostCenter.getCostCenterName(), 0, "");
